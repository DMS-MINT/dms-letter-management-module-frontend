	...
	return (
		<div className="flex items-center justify-between px-2 text-gray-900">
			<div className="flex-1 text-sm text-muted-foreground">
				{table.getFilteredSelectedRowModel().rows.length} ከ{" "}
				{table.getFilteredRowModel().rows.length} ረድፍ(ዎች) ተመርጧል።
			</div>
			<div className="flex items-center space-x-6 lg:space-x-8">
				...
				<div className="flex w-[100px] items-center justify-center text-sm font-medium">
					ገጽ {table.getState().pagination.pageIndex + 1} ከ {table.getPageCount()}
				</div>
				<div className="flex items-center space-x-2">
					<Button
						variant="outline"
