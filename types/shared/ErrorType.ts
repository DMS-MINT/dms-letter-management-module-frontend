export enum ErrorCodeEnum {
	...
	"USERDEFAULTSIGNATURE_NOT_FOUND" = "USERDEFAULTSIGNATURE_NOT_FOUND", // 400

	// Notification-specific errors
	"NOTIFICATION_NOT_FOUND" = "NOTIFICATION_NOT_FOUND", // 404
	"NOTIFICATION_FAILED" = "NOTIFICATION_FAILED", // 500
	"INVALID_NOTIFICATION_DATA" = "INVALID_NOTIFICATION_DATA", // 400
}
